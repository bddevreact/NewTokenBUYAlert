...
class SolanaWalletMonitor:
    def __init__(self, wallet_address: str, rpc_url: str = "https://api.mainnet-beta.solana.com"):
        ...
        self.wallet_pubkey = PublicKey(wallet_address)
...
*Time:* {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S UTC')}"""
    ...
    async def send_telegram_alert(self, message: str):
        ...
        try:
            ...
            # Clean up chat_id (remove spaces)
...
async def main():
    ...
    WALLET_ADDRESS = os.getenv("WALLET_ADDRESS", "gasTzr94Pmp4Gf8vknQnqxeYxdgwFjbgdJa4msYRpnB")
    ...
    monitor = SolanaWalletMonitor(WALLET_ADDRESS, RPC_URL)
