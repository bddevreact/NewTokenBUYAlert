            ...
            for instruction in instructions:
                ...
                if program_id_index >= 0 and program_id_index < len(account_keys):
                    ...
                    if program_id == "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA":
                        ...
                        if data:
                            # Decode base64 data to check instruction type
                            import base64
                            try:
...
def main():
    ...
    monitor = NewTokenMonitor(WALLET_ADDRESS, TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID, RPC_URL)
...
if __name__ == "__main__":
    print("🤖 Solana New Token Launcher Monitor Bot")
    print("=" * 50)
    print("Monitoring for NEW LAUNCHED TOKENS only!")
    print("=" * 50)
